...
module.exports = () => {
    return inquirer.prompt([
        ...
        },
        {
            type: 'list',
            name: 'textChoice',
            message: 'Choose your preferred text color from the options listed below:',
        ...
        },
        {
            type: 'list',
            name: 'shapeChoice',
            message: 'Choose your preferred shape color from the options listed below:',
            choices: ["Red", "Yellow", "Green", "Blue", "Gray"],
